...
medaka_model <- "r941_e81_hac_g514"
...
sd_noise_score <- 0.2
########################################################################################################
PIPELINE_DIR <- "/softs/apps/charONT/1.1.0/"
#MINICONDA DIR
MINICONDA_DIR <- "/softs/apps/conda3"
#basecaller_dir
...
MAFFT <- paste0("mafft")
#VSEARCH
VSEARCH <- paste0("vsearch")
#RACON
RACON <- paste0("racon")
#MEDAKA
MEDAKA <- paste0("medaka")
#EMBOSS cons
CONS <- paste0("cons")
#SEQTK
SEQTK <- paste0("seqtk")
#MINIMAP2
MINIMAP2 <- paste("minimap2")
#SAMTOOLS
SAMTOOLS <- paste0("samtools")
#TRF
TRF <- paste0("trf")
#PYCOQC
PYCOQC <- paste0("pycoQC")
#NANOFILT
NANOFILT <- paste0("NanoFilt")
#MSA
MSA <- paste0("msa.sh")
#CUTPRIMERS
CUTPRIMERS <- paste0("cutprimers.sh")
